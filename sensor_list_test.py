...
all_xbee_sensors = ['Time'
                    'FL_VSS', 'FR_VSS', 'BL_VSS', 'BR_VSS', 'FL_SUS_POT', 
                    'FR_SUS_POT', 'BL_SUS_POT', 'BR_SUS_POT','FL_BRK_TMP', 'FR_BRK_TMP',
                     'BL_BRK_TMP', 'BR_BRK_TMP', 'F_BRK_PRES', 'B_BRK_PRES', 'COOL_TEMP', 
                     'STEER_ANG', 'TPS', 'OIL_TEMP', 'OIL_PRES', 'MAP',
                      'MAT', 'NEUT', "LAMBDA1", "LAMBDA2", 
                      'ACCELX','ACCELY', 'ACCELZ', 
                      'GYROX', 'GYROY', 'GYROZ', 
                      'MAGNETX', 'MAGNETY', 'MAGNETZ']
                      #'VOL','RPM','GEAR','IGNTN', 'POG','POG2', 'POG3']
                      
        # ['FL_VSS', 'FR_VSS', 'BL_VSS', 'BR_VSS', 'FL_SUS_POT', 'FR_SUS_POT', 'BL_SUS_POT', 'BR_SUS_POT',
